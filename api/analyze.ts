...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    for (const ativo of ATIVOS) {
      ...
      // --- LÓGICA FRACTAL 5 PERÍODOS (Baseado no seu Script) ---
      // Fractal Alta: Mínima central [i-2] é a menor das 5 velas
      ...
      // Fractal Baixa: Máxima central [i-2] é a maior das 5 velas
      ...
      const rsiSubindo = rsiVal > rsiAnt;
      const rsiCaindo = rsiVal < rsiAnt;

      // --- CONDIÇÕES DE COR E SINAL ---
      ...
      if (sinalStr && dentroDaJanela) {
        ...
        if (lastSinais[ativo.label] !== signalKey) {
          ...
          const msg = `${icon} <b>SINAL FRACTAL DETECTADO!</b>\n\n<b>ATIVO:</b> ${ativo.label}\n<b>SINAL:</b> ${sinalStr}\n<b>RSI 9:</b> ${rsiVal.toFixed(1)}\n<b>VELA:</b> ${hV}`;
      ...
      <body> 
        <div class="main-card"> 
          ...
          <table class="revision-table"> 
            ...
            <tbody> 
              <tr><td>35</td><td>08/02/26</td><td>08:45</td><td>Gatilho Fractal 5 + RSI 9 (Script RT)</td></tr>
              <tr><td>34</td><td>07/02/26</td><td>18:25</td><td>IA Martingale + Fibonacci</td></tr>
              <tr><td>33</td><td>07/02/26</td><td>15:45</td><td>Filtro de Janela 10min</td></tr> 
            </tbody> 
          </table> 
        </div> 
